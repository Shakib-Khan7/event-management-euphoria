...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer p-20 bg-gray-900 text-white text-xl mt-20">
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">Phone : 00 0033 44</a>
    <a className="link link-hover">Email : euphoria@gmail.com</a>
...
<footer className="footer px-10 py-4  bg-gray-900 text-white border-base-300 text-xl">
  <aside className="items-center grid-flow-col">
    ...
    <p>Euphoria Event Management. <br/>Providing Best Event Experience Since 2002</p>
  </aside> 
